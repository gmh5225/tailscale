...
type Notify struct {
	...
	// Some client applications like the MacOS and Windows clients, will listen
	// for updates to this and handle serving these shares unde the identity of
	// the unprivileged user that is running the application.
